...
if($testserver->getStatusCode() == 200){	
	...
	$products = \R::getAll("SELECT product.id, product.article, product.stock_status_id FROM product, category WHERE product.category_id = category.id AND category.id IN ('9', '18', '19', '20', '21', '22', '23', '24', '26', '27', '28', '29', '30', '35')");
