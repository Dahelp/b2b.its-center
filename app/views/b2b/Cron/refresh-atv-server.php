...
if($testserver->getStatusCode() == 200){	
	...
	$products = \R::getAll("SELECT product.id, product.article, product.stock_status_id FROM product, category WHERE product.category_id = category.id AND category.id = '2'");
