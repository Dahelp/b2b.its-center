...
$products = \R::getAll("SELECT product.article, product.name, product.quantity, product.price FROM product, category WHERE category.id = product.category_id AND category.parent_id = ? AND product.hide = ?", [25, 'show']);
