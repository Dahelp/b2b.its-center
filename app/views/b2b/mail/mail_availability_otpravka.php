...
<head>
    ...
    <title>Оповещение о поступлении товара на сайте <?=$namecomp?></title>
</head>
<body>
				...
				<tr>
					<td>
						<table cellspacing="0" cellpadding="0" style="width:660px;padding:20px;font-family:Tahoma, Helvetica, sans-serif;color:#212529;font-size:13px" align="center">
							<tr>
								<td colspan="4" style="padding:20px 0 20px 0">Здравствуйте, оповещаем Вас о поступлении товара на сайте <?=$namecomp?>.<br><br>									
									<b>Товар:</b> <?=$product["name"]?><br><br>								
									<b>Наличие:</b> <?=$product["quantity"]?> шт.<br><br>
									<b>Цена:</b> <?=$product["price"]?> руб.<br><br><br>
