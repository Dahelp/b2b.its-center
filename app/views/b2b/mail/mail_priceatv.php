...
<head>
    ...
    <title>Запрос на отправку каталога</title>
</head>
<body>
				...
				<tr>
					<td>
						<table cellspacing="0" cellpadding="0" style="width:660px;padding:20px;font-family:Tahoma, Helvetica, sans-serif;color:#212529;font-size:13px" align="center">
							<tr>
								<td colspan="4" style="padding:20px 0 20px 0">На сайт <?=$namecomp?> поступил запрос каталога на шины общего назначения.<br><br>	
