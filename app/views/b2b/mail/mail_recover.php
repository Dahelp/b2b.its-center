				...
				<tr>
					<td>
						<table cellspacing="0" cellpadding="0" style="width:660px;padding:20px;font-family:Tahoma, Helvetica, sans-serif;color:#212529;font-size:13px" align="center">
							<tr>
								<td colspan="4" style="padding:20px 0 20px 0">Добрый день, <?=$user_name?>!<br><br>
									На сайт <?=$namecomp?> поступила заявка на восстановление пароля.<br>
									Чтобы восстановить пароль пройдите по <a href="<?=$reset_link?>">ссылке</a>.<br><br>
									<b>Время запроса на востановление:</b> <?=date("Y-m-j H:i:s")?><br><br>
									Время действия ссылки 1 час<br><br>
										С уважением, <?=$shop_name?> <br>
